...
import com.ibm.streamsx.weather.internal.api.impl.DailyForecast;

@PrimitiveOperator(name="DailyForecast", namespace="com.ibm.streamsx.weather")
public class DailyForecastOp extends AbstractForecastOperator {
	...
	protected void initWeatherApi(OperatorContext context) throws Exception {
		forecast = new DailyForecast(getUsername(), getPassword());
	}
